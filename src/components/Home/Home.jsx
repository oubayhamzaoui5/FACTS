...
function Home() {
  return (
    ...
    >
      <div className={styles.heroText}>
        <img src={logowImage} alt="FACTS Logo" className={styles.titleImage} />
        <p className={styles.slogan}>Unmask the truth, Elevate the voice.</p>
          ...
          {/* Text Detector Section */}
            ...
            <div className={styles.detectorContent}>
                <img src={textScan} alt="Text Detection Illustration" className={styles.detectorImage} />
      ...
      <section className={`${styles.section} ${styles.extensionSection}`}>
        <div className={styles.extensionContent}>
          ...
          <img src={extensionImage} alt="Extension Icon" className={styles.extensionImage} />
        </div>
      </section>
  ...
  <img src={ journalistImage} alt="Become a Journalist" className={styles.journalistImage} />
